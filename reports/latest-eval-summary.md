...
| Metric | OpenAI baseline | OpenAI candidate | Reference target | Delta | Gap to target |
| --- | --- | --- | --- | --- | --- |
| Overall score | 0.89 | 0.91 | 0.90 | +0.02 | -0.01 |
| Citation support | 0.96 | 0.99 | 0.96 | +0.03 | -0.03 |
| Coverage | 0.92 | 0.96 | 0.93 | +0.04 | -0.03 |
| Grounding risk units | 10 | 5 | 6 | -5 | -1 |
| Eval cases | 7 | 7 | 7 | 0 | 0 |
| Median latency | 12.6s | 7.1s | 8.0s | -5.5s | -0.9s |
| Estimated cost | 0.07009975 | 0.0295 | <= 0.1 | -0.04059975 | -0.0705 |
